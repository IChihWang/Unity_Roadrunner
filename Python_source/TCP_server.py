...
class TCP_Server(object):
    def __init__(self, IP, port):
        ...
        self.UnityThread = None
        self.UnityRunningFlag = [True]
    ...
    def StartServer(self, UnityQueue):
        ...
        while i < self.Num_Listener:
            ...
            if ClientName == 'U3D00'.encode('utf8'):
                ...
                self.UnityError, self.UnityThread = Unity.StartUnity(self.UnityClient, UnityQueue, self.UnityRunningFlag)
